...
class TreesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tree" do
    assert_difference("Tree.count") do
      post trees_url, params: { tree: { devto: @tree.devto, facebook: @tree.facebook, instagram: @tree.instagram, name: @tree.name, x: @tree.x, youtube: @tree.youtube } }
    end
  ...
  test "should update tree" do
    patch tree_url(@tree), params: { tree: { devto: @tree.devto, facebook: @tree.facebook, instagram: @tree.instagram, name: @tree.name, x: @tree.x, youtube: @tree.youtube } }
